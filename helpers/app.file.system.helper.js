...
const cleanupProjectFolder = async (projectFolder)=>{
  return new Promise(async(resolve, reject)=>{
...
const finalizeArchiveFolder = (src) =>{
...
module.exports = { createAppFolders, prepareArchiveFolder, finalizeArchiveFolder }